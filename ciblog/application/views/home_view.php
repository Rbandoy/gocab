  ...
  <body class="amp-mode-mouse" style="opacity: 1; visibility: visible; animation: 0s ease 0s 1 normal none running none;">
    ...
    <table>
      ...
      <tr>
        ...
        <td><input class="btn btn-md btn-primary display-4" type='Submit' value='Insert' name='insert'"/>
        <input class="btn btn-md btn-primary display-4" type='Submit' value='View' name='view'"/>
        <input class="btn btn-md btn-success display-4" type='Submit' value='Search' name='search'"/>
        <input class="btn btn-md btn-warning display-4" type='Submit' value='Update' name='update'"/>
        <input class="btn btn-md btn-warning display-4" type='Submit' value='Delete' name='delete'"/>
        </div>
      </td>
      </tr>
    </table>
